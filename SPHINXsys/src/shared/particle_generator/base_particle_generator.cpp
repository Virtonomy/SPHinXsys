...
namespace SPH
{
	...
	//=================================================================================================//
	ParticleGeneratorDirect::ParticleGeneratorDirect(StdVec<std::array<double, Dimensions>>& pos_0, StdVec<double>& volume)
	{
		// we add the generated particles for the direct generator
		for(size_t particle_i = 0; particle_i < pos_0.size(); particle_i++)
		{
			positions_volumes_.push_back(std::make_pair(Vecd(pos_0[particle_i].data()),volume[particle_i]));
		}
	}
	//=================================================================================================//
