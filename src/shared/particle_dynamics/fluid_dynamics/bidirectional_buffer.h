...
#ifndef BD23F751_BA22_4F7D_9B70_3C2C52EE823D
#define BD23F751_BA22_4F7D_9B70_3C2C52EE823D
...
class BidirectionalBuffer
{
    ...
    class Injection : public BaseDynamics<void>, public LocalDynamics, public GeneralDataDelegateSimple
    {
      public:
        Injection(ConcurrentIndexVector &buffer_particle_list, RealBody &real_body, SharedPtr<AlignedBoxShape> shape_ptr,
                  size_t body_buffer_width, int axis_direction, BidirectionalBuffer &buffer) : BaseDynamics<void>(real_body), LocalDynamics(real_body), GeneralDataDelegateSimple(real_body),
  ...
  public:
    BidirectionalBuffer(RealBody &real_body, SharedPtr<AlignedBoxShape> shape_ptr,
                        size_t body_buffer_width, int axis_direction) : tag_buffer_particles(this->buffer_particle_list_, real_body, shape_ptr),
...
#endif /* BD23F751_BA22_4F7D_9B70_3C2C52EE823D */
