...
TEST(CubeCompression, TimeDependentPressure)
{
	...
	Real pressure = 6250.0; // 10N force on the surface
	...
	input.surface_pressure_tuple_ = StdVec<PressureTuple>{ PressureTuple(0, &cube, Vec3d(0.1, 0.02, 0.02), pressure_over_time) };
