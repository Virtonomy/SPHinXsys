...
//=================================================================================================//
template <class BoundaryConditionConfig, class ConditionType>
void BufferInflowInjectionCK<BoundaryConditionConfig, ConditionType>::UpdateKernel::update(size_t index_i, Real dt)
{
...
template <class KernelCorrectionType, typename BoundaryConditionConfig, typename ConditionType>
template <class ExecutionPolicy, class EncloserType>
PressureVelocityCondition<KernelCorrectionType, BoundaryConditionConfig, ConditionType>::UpdateKernel::
    UpdateKernel(const ExecutionPolicy &ex_policy, EncloserType &encloser)
...
//=================================================================================================//
template <class KernelCorrectionType, typename BoundaryConditionConfig, typename ConditionType>
void PressureVelocityCondition<KernelCorrectionType, BoundaryConditionConfig, ConditionType>::
